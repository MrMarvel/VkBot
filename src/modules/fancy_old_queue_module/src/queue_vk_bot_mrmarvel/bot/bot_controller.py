...
class BotController(IBot):
    ...
    def send_request_with_return(self, method, context):
        context['random_id'] = time.time_ns()
        context['v'] = '5.131'
        request_method = method
        response_all = self._send_request({'method': request_method, 'body': context})
    ...
    def get_user(self, user_id: int) -> dict | None:
        ...
        method = "users.get"
        return self.send_request_with_return(method, body)
